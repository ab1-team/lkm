    ...
    <table width="97%" border="0" align="center" cellpadding="3" cellspacing="0">
        <tr>
            <td height="50" colspan="3" class="bottom">
                <p align="center" class="style6" style="font-size: 18pt; font-weight: bold;">KESANGGUPAN<br>PENGADAAN BARANG
                    JAMINAN</p>
            </td>
        </tr>
        <tr>
        ...
        @if ($jaminan['jenis_jaminan'] == '1')
            ...
            <tr>
                <td height="10" colspan="3" class="style9"> guna memenuhi persyaratan permohonan kredit dengan Nomor
                    Registrasi {{ $pinkel->id }} pada {{ $kec->nama_lembaga_sort }}.
        ...
        @elseif ($jaminan['jenis_jaminan'] == '4')
            <tr>
                <td height="10" colspan="3" class="style9">Menyatakan sanggup mengadakan barang jaminan berupa:
                </td>
            </tr>
            <tr>
                <td width="5">&nbsp;</td>
            ...
            <tr>
                <td height="10" colspan="3" class="style9"> guna memenuhi persyaratan permohonan kredit dengan
                    Nomor Registrasi {{ $pinkel->id }} pada {{ $kec->nama_lembaga_sort }}.
                    Demikian surat pernyataan kesanggupan ini saya buat dengan penuh kesadaran dan untuk menjadikan
                    periksa bagi yang berkepentingan.
                </td>
            </tr>
