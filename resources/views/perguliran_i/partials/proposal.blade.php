<form action="/perguliran_i/{{ $perguliran_i->id }}" method="post" id="FormInput">
                        ...
                        <table class="table align-items-center mb-0 table-sm">
                            <tbody>
                                <tr>
                                    ...
                                    <td class="text-sm font-weight-bold text-dark py-2">: {{ Tanggal::tglIndo($perguliran_i->tgl_proposal) }}</td>
                                </tr>
                                <tr>
                                    <td class="text-sm text-muted ps-0 py-2">Nominal Pengajuan</td>
                                    <td class="text-sm font-weight-bold text-success py-2">: Rp. {{ number_format($perguliran_i->proposal) }}</td>
                                </tr>
                                <tr>
                                    <td class="text-sm text-muted ps-0 py-2">Jenis Jasa</td>
                                    <td class="text-sm font-weight-bold text-dark py-2">: {{ $perguliran_i->jasa->nama_jj }}</td>
                                </tr>
                            </tbody>
                        </table>
                    </div>
                        ...
                        <table class="table align-items-center mb-0 table-sm">
                            <tbody>
                                <tr>
                                    ...
                                    <td class="text-sm font-weight-bold text-dark py-2">: {{ $perguliran_i->pros_jasa . '% / ' . $perguliran_i->jangka . ' bulan' }}</td>
                                </tr>
                                <tr>
                                    <td class="text-sm text-muted ps-0 py-2">Angsuran Pokok</td>
                                    <td class="text-sm font-weight-bold text-dark py-2">: {{ $perguliran_i->sis_pokok->nama_sistem }}</td>
                                </tr>
                                <tr>
                                    <td class="text-sm text-muted ps-0 py-2">Angsuran Jasa</td>
                                    <td class="text-sm font-weight-bold text-dark py-2">: {{ $perguliran_i->sis_jasa->nama_sistem }}</td>
                                </tr>
                            </tbody>
                        </table>
                    </div>
    ...
    <div class="card mb-4 shadow-sm border-0" style="border-radius: 12px;">
        <div class="card-header bg-white border-bottom py-3">
            <div class="d-flex align-items-center">
                <div class="icon icon-shape bg-gradient-primary shadow-primary text-center border-radius-md me-3 d-flex align-items-center justify-content-center" style="width: 36px; height: 36px;">
            ...
            <div class="row">
                <div class="col-md-3">
                    <div class="form-group mb-3">
                        <label for="tgl_verifikasi" class="form-control-label text-xs font-weight-bold text-uppercase text-muted">Tgl Verifikasi</label>
                ...
                <div class="col-md-3">
                    <div class="form-group mb-3">
                        <label for="verifikasi" class="form-control-label text-xs font-weight-bold text-uppercase text-muted">Verifikasi Rp.</label>
                        <input autocomplete="off" type="text" name="verifikasi" id="verifikasi"
                            class="form-control money font-weight-bold" value="{{ number_format($perguliran_i->proposal, 2) }}">
            ...
            <div class="row mt-2">
                <div class="col-md-12">
                    <div class="form-group mb-0">
                        <label for="catatan_verifikasi" class="form-control-label text-xs font-weight-bold text-uppercase text-muted">Catatan Verifikasi</label>
        ...
        <div class="card-footer bg-light border-top py-3 text-end">
            <button type="button" id="tdklayak"
                class="btn btn-warning text-danger btn-sm mb-0 font-weight-bold px-4 shadow-sm me-2 text-nowrap"
            ...
            <button type="button" id="Simpan" class="btn btn-primary btn-sm mb-0 font-weight-bold px-4 shadow-sm text-nowrap"
                @if (!in_array('perguliran.simpan_verifikator', Session::get('tombol', []))) disabled @endif>
