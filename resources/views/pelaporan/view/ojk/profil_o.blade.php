            ...
            <td colspan="2">
                ...
                <table border="0" width="100%">
                    ...
                    <tr>
                        ...
                        <td align="center"class="style9 bottom align- center" width="33%">
                            {{ number_format($pros_saham1) }}&nbsp;</td>
                    </tr>
                </table>
            </td>
        </tr>
                    ...
                    @foreach ($kec->saham as $sa)
                        ...
                        <tr>
                            @for ($i = 0; $i < $maxCount; $i++)
                                @if ($i == 0)
                                    @if ($sa->nama_direksi)
                                        <td class="style9 bottom align-center" width="50%">
                                            {{ $sa->nama_direksi }}&nbsp;</td>
                                    @else
                                ...
                                @if ($i == 0)
                                    @if ($sa->nama_kom)
                                        <td class="style9 bottom align-center" width="50%">{{ $sa->nama_kom }}&nbsp;
                                        </td>
                                    @else
                                        <td class="style9 bottom align-center" width="50%">&nbsp;</td>
                                    @endif
                                    ...
                                    @if ($sa->jab_kom)
                                        <td class="style9 bottom align-center" width="50%">{{ $sa->jab_kom }}&nbsp;
                                        </td>
                                    @else
                                        <td class="style9 bottom align-center" width="50%">&nbsp;</td>
                                    @endif
