...
@section('content')
    ...
    @foreach ($jenis_pp as $jpp)
        ...
        @if ($page_break)
            <div class="break"></div>
        @endif
        @php $page_break = true; @endphp

        <table border="0" width="100%" cellspacing="0" cellpadding="0" style="font-size: 11px;">
            <tr>
                <td colspan="3" align="center">
                    <div style="font-size: 18px;">
                        <b>DAFTAR PERKEMBANGAN PIUTANG PER KELOMPOK {{ strtoupper($jpp->nama_jpp) }}</b>
                    </div>
            ...
            @empty
                <tr>
                    <td class="t l b r" colspan="17" align="center" style="padding: 8px 0;">
                        <em>Tidak ada data pinjaman kelompok mingguan untuk {{ $jpp->nama_jpp }}</em>
                    </td>
                </tr>
            @endforelse
                ...
                <tr>
                    <td colspan="17" style="padding: 0px !important;">
                        <table class="p" border="0" width="100%" cellspacing="0" cellpadding="0"
                            ...
                            @if (!empty($kec) && !empty($kec->ttd) && !empty($kec->ttd->tanda_tangan_pelaporan))
                                <tr>
                                    <td colspan="17">
