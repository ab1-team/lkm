...
@section('content')
    <table border="0" width="100%" cellspacing="0" cellpadding="2" style="font-size: 10px;">
        <tr>
            <td colspan="3" align="center" style="font-size: 14px;">
                <b>LAPORAN PENILAIAN TINGKAT KESEHATAN DAN STATUS PENGAWASAN</b>
            </td>
        </tr>
        <tr>
        ...
        <tr>
            <td colspan="3" align="center" style="font-size: 11px;">
                (Berdasarkan POJK No. 41 Tahun 2024 &amp; POJK No. 49 Tahun 2024)
            </td>
        </tr>
    </table>
    <br>
    ...
    <table border="0" width="100%" cellspacing="0" cellpadding="3" style="font-size: 10px; border: 1px solid #000;">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td class="t l b r">Pinjaman Bermasalah (Kurang Lancar + Diragukan + Macet)</td>
                <td class="t l b r" align="right">{{ number_format($a['npl_bermasalah'], 0, ',', '.') }}</td>
            </tr>
            <tr>
                <td class="t l b r" align="center">9</td>
                <td class="t l b r">Nilai Agunan Diakui (setelah pengakuan OJK)</td>
                <td class="t l b r" align="right">{{ number_format($a['agunan_bermasalah'], 0, ',', '.') }}</td>
            </tr>
            <tr>
            ...
            <tr>
                <td class="t l b r" align="center">11</td>
                <td class="t l b r">PPAP Wajib Minimum (akumulasi per kolektibilitas)</td>
    ...
    <table border="0" width="100%" cellspacing="0" cellpadding="3" style="font-size: 9px; border: 1px solid #000;">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td class="t l b r">NPL/NPF Neto (Bermasalah &minus; PPAP &minus; Agunan)</td>
    ...
    <table border="0" width="100%" cellspacing="0" cellpadding="4" style="font-size: 10px; border: 1px solid #000;">
        ...
        <tr style="background: rgb(255,247,224); font-weight: bold;">
            <td class="t l b r" align="center" style="font-size: 12px;">PK {{ $a['pk'] }}</td>
    ...
    <div style="font-size: 11px; font-weight: bold; background: rgb(232,232,232); padding: 4px;">
        D. STATUS PENGAWASAN (POJK No. 49 Tahun 2024)
    </div>
    <table border="0" width="100%" cellspacing="0" cellpadding="4" style="font-size: 10px; border: 1px solid #000;">
        ...
        <tr>
            <td class="t l b r" align="center">1</td>
            <td class="t l b r">Pengawasan Normal</td>
            <td class="t l b r">Memenuhi seluruh rasio kuantitatif POJK &amp; Peringkat Komposit 1-3.</td>
        </tr>
        <tr>
            <td class="t l b r" align="center">2</td>
    ...
    <div style="font-size: 11px; font-weight: bold; background: rgb(232,232,232); padding: 4px;">
        E. RINGKASAN PPAP PER KOLEKTIBILITAS
    </div>
    <table border="0" width="100%" cellspacing="0" cellpadding="3" style="font-size: 9px; border: 1px solid #000;">
        <thead>
            <tr style="background: rgb(245,245,245);">
