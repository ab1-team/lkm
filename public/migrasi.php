...
if (isset($_POST['copy'])) {
    ...
    if (mysqli_num_rows($query) <= 0) {
        ...
        mysqli_query($koneksi, "INSERT INTO siupk_dbm.tanda_tangan_dokumen (`id`, `lokasi`, `tanda_tangan_pelaporan`, `tanda_tangan_spk`) VALUES (NULL, '$lokasi', '$ttd_pelaporan', '$ttd_spk')");
    }
