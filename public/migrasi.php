...
if (isset($_POST['copy'])) {
    ...
    $query = mysqli_query($koneksi, "SELECT * FROM siupk_dbm.tanda_tangan_dokumen WHERE lokasi='$lokasi'");
    if (mysqli_num_rows($query) <= 0) {
        ...
        mysqli_query($koneksi, "INSERT INTO siupk_dbm.tanda_tangan_dokumen (`id`, `lokasi`, `jenis`, `tanda_tangan`) VALUES (NULL, '$lokasi', 'laporan', '$ttd_pelaporan'), (NULL, '$lokasi', 'spk', '$ttd_spk')");
    }
